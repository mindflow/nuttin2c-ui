...
class Dependencies {
    ...
    constructor() {
        this.componentClass = nuttin2c_core_v1.Component;
    }
...
class BackShade {
    ...
    constructor(backShadeListeners = new BackShadeListeners()){
        ...
        this.componentFactory = mindi_v1.InjectionPoint.instance(nuttin2c_core_v1.InlineComponentFactory);
    ...
    hideAfter(milliSeconds) {
        ...
        const disableStylePromise = coreutil_v1.TimePromise.asPromise(milliSeconds + 1,
            () => {
                nuttin2c_core_v1.CanvasStyles.disableStyle(BackShade.name, this.component.componentIndex);
            }
        );
    ...
    show() {
        ...
        this.hidden = false;
        nuttin2c_core_v1.CanvasStyles.enableStyle(BackShade.name, this.component.componentIndex);
...
class BackgroundVideo {
	...
	postConfig() {
		...
		nuttin2c_core_v1.CanvasStyles.enableStyle(BackgroundVideo.name);
...
class Background {
	...
	postConfig() {
		...
		if (this.backgroundImagePath) {
            nuttin2c_core_v1.StyleAccessor.from(this.component.get("background"))
                .set("background-image", "url(\"" + this.backgroundImagePath + "\")");
		}
		nuttin2c_core_v1.CanvasStyles.enableStyle(Background.name);
	}
...
class BannerLabelMessage {
    ...
    constructor(message, bannerType = BannerLabelMessage.TYPE_INFO, customAppearance = null) {
        ...
        /** @type {EventManager} */
        this.eventManager = new nuttin2c_core_v1.EventManager();
    }
    ...
    async postConfig() {
        ...
        nuttin2c_core_v1.CanvasStyles.enableStyle(BannerLabelMessage.name);
        nuttin2c_core_v1.StyleSelectorAccessor.from(this.messageContentElement)
    ...
    hide() {
        ...
        coreutil_v1.TimePromise.asPromise(500, () => {
            if (!this.isVisible) {
                nuttin2c_core_v1.StyleAccessor.from(this.component.get("bannerLabelMessage"))
                    .set("display", "none");
            }
        });
    }
...
class BannerLabel {
    ...
    async postConfig() {
        ...
        nuttin2c_core_v1.CanvasStyles.enableStyle(BannerLabel.name);
        this.success.hide();
        this.warning.hide();
        this.error.hide();
...
class BannerMessage {
    ...
    async hide() {
        ...
        await coreutil_v1.TimePromise.asPromise(500, () => { 
            ...
            nuttin2c_core_v1.CanvasStyles.disableStyle(BannerMessage.name, this.component.componentIndex);
        });
    ...
    async show(newHeader = null, newMessage = null) {
        ...
        nuttin2c_core_v1.CanvasStyles.enableStyle(BannerMessage.name, this.component.componentIndex);
...
class DropDownPanel {
    ...
    postConfig() {
        ...
        nuttin2c_core_v1.CanvasStyles.enableStyle(DropDownPanel.name);
        this.component.get("button").setChild(nuttin2c_core_v1.HTML.i("", this.iconClass));

        nuttin2c_core_v1.StyleSelectorAccessor.from(this.component.get("button"))
            .enable(DropDownPanel.BUTTON)
            .enable(this.type);

        nuttin2c_core_v1.StyleSelectorAccessor.from(this.component.get("content"))
        ...
        nuttin2c_core_v1.CanvasRoot.listenToFocusEscape(this.component.get("dropDownPanelRoot"), this.hide, this);
    }
    ...
    toggleContent() {
        if (!nuttin2c_core_v1.StyleAccessor.from(this.component.get("arrow")).is("display","block")) {
            this.show();
        } else {
            this.hide();
        }
    ...
    show() {
        ...
        nuttin2c_core_v1.StyleAccessor.from(this.component.get("arrow"))
            .set("display", "block");
...
class CommonInput {
    ...
    postConfig() {
        ...
        nuttin2c_core_v1.CanvasStyles.enableStyle(this.componentClass.name, this.component.componentIndex);
        ...
        if(this.model) {
            this.dataBinding = nuttin2c_core_v1.InputElementDataBinding.link(this.model, this.validator).to(this.component.get(this.inputElementId));
        }
...
class Panel {
    ...
    postConfig() {
        ...
        nuttin2c_core_v1.CanvasStyles.enableStyle(Panel.name);

        nuttin2c_core_v1.StyleSelectorAccessor.from(this.component.get("panel"))
            .enable(this.type)
...
class LinePanel {
	...
	constructor(buttonPanel = null) {
        ...
        this.arrayState = new nuttin2c_core_v1.StateManager();
...
class LinkPanel {
    ...
    postConfig() {
        ...
        nuttin2c_core_v1.CanvasStyles.enableStyle(LinkPanel.name);
        
        nuttin2c_core_v1.StyleSelectorAccessor.from(this.component.get("link"))
            .enable(this.size)
            .enable(this.orientation)
            .enable(this.theme);
        ...
        if (this.icon) {
            nuttin2c_core_v1.StyleSelectorAccessor.from(this.component.get("icon"))
                .clear()
                .enable(this.icon);
        } else {
...
class PopUpPanel {
    ...
    postConfig() {
        ...
        nuttin2c_core_v1.CanvasStyles.enableStyle(PopUpPanel.name);
        this.component.get("button").setChild(nuttin2c_core_v1.HTML.i("", this.iconClass));
        ...
        this.component.get("button").listenTo("click", this.clicked, this);
        nuttin2c_core_v1.CanvasRoot.listenToFocusEscape(this.component.get("popUpPanelRoot"), this.hide, this);
    }
...
class SlideDeckEntry {
    ...
    async postConfig() {
        ...
        nuttin2c_core_v1.CanvasStyles.enableStyle(SlideDeckEntry.name);
    }
    ...
    setContentVisibility(contentVisibility) {
        nuttin2c_core_v1.StyleSelectorAccessor.from(this.contentElement).replace("existance-", contentVisibility);
    }

    setShift(position) {
        this.position = position;
        nuttin2c_core_v1.StyleSelectorAccessor.from(this.entryElement).replace("position-", position);
    }
...
class SlideDeck {
    ...
    constructor(componentMap) {
        ...
        /** @type {EventManager} */
        this.events = new nuttin2c_core_v1.EventManager();
    }
    ...
    async postConfig() {
        ...
        nuttin2c_core_v1.CanvasStyles.enableStyle(SlideDeck.name);
...
class RadioToggleIcon {
    ...
    postConfig() {
        ...
        nuttin2c_core_v1.CanvasStyles.enableStyle(RadioToggleIcon.name);
        ...
        if (this.model) {
            nuttin2c_core_v1.InputElementDataBinding.link(this.model).to(radio);
        }
...
class ToggleIcon {
    ...
    postConfig() {
        ...
        nuttin2c_core_v1.CanvasStyles.enableStyle(ToggleIcon.name);
...
class TreePanelEntry {
	...
	async enableBorder() {
		nuttin2c_core_v1.StyleSelectorAccessor.from(this.component.get("root")).enable("cntr-round-bordered");
	}
	...
	async toggleChildElements(visible) {
		if (visible) {
			nuttin2c_core_v1.StyleSelectorAccessor.from(this.component.get("subrecordElementsContainer")).disable("hidden");
			return;
		}
		nuttin2c_core_v1.StyleSelectorAccessor.from(this.component.get("subrecordElementsContainer")).enable("hidden");
	}
	...
	async toggleButtons(visible) {
		if (visible) {
			nuttin2c_core_v1.StyleSelectorAccessor.from(this.component.get("buttonsContainer")).disable("hidden");
			return;
		}
		nuttin2c_core_v1.StyleSelectorAccessor.from(this.component.get("buttonsContainer")).enable("hidden");
	}
...
class DialogBox {
    ...
    async close() {
        ...
        if (options.contains(DialogBox.OPTION_BACK_ON_CLOSE)) {
            nuttin2c_core_v1.Navigation.instance().back();
        }
    }
    ...
    hide(event) {
        ...
        const disableStylePromise = coreutil_v1.TimePromise.asPromise(201, () => {
                ...
                nuttin2c_core_v1.CanvasStyles.disableStyle(DialogBox.name, this.component.componentIndex);
            }
        );
    ...
    show(event, temporaryOptions) {
        ...
        this.destroyFocusEscapeListener = nuttin2c_core_v1.CanvasRoot.listenToFocusEscape(
        ...
        nuttin2c_core_v1.CanvasRoot.swallowFocusEscape(500);
        if (!this.hidden) {
            return new Promise((resolve, reject) => {resolve();});
        }
        this.hidden = false;
        nuttin2c_core_v1.CanvasStyles.enableStyle(DialogBox.name, this.component.componentIndex);
        this.backShade.show();
        ...
        nuttin2c_core_v1.CanvasRoot.mouseDownElement = this.component.get("dialogBoxContent").containerElement;
        return coreutil_v1.TimePromise.asPromise(100,  () => {
...
class Button {
    ...
    postConfig() {
        ...
        nuttin2c_core_v1.CanvasStyles.enableStyle(Button.name);
        if (this.iconClass) {
            this.component.get("button").addChild(nuttin2c_core_v1.HTML.i("", this.iconClass));
        }
        if (this.label) {
    ...
    enableLoading() {
        nuttin2c_core_v1.StyleSelectorAccessor.from(this.component.get("spinnerContainer"))
...
class CheckBox {
    ...
    postConfig() {
        ...
        nuttin2c_core_v1.CanvasStyles.enableStyle(CheckBox.name);
        this.component.get("checkBox").setAttributeValue("name",this.name);

        if(this.model) {
            nuttin2c_core_v1.InputElementDataBinding.link(this.model).to(this.component.get("checkBox"));
        }
    }
...
class EmailInput extends CommonInput {
    ...
    constructor(name, model = null, placeholder = TextInput.DEFAULT_PLACEHOLDER, mandatory = false) {
        ...
        super(EmailInput,
            name,
            model,
            new nuttin2c_core_v1.EmailValidator(mandatory, !mandatory),
            placeholder,
            "emailInput",
            "emailError");
    }
...
class FileUploadEntry {
    ...
    async postConfig() {
        ...
        nuttin2c_core_v1.CanvasStyles.enableStyle(FileUploadEntry.name);
...
class FileUpload {
    ...
    constructor(name, multiple = false, fileTypeArray = []) {
        ...
        this.fileArrayState = new nuttin2c_core_v1.StateManager();
    ...
    postConfig() {
        ...
        nuttin2c_core_v1.CanvasStyles.enableStyle(FileUpload.name);
    ...
    showUnsupportedFiles(unsupportedFiles) {
        ...
        if (unsupportedFiles.length > 0) {
            ...
            for (const file of unsupportedFiles) {
                const messageElement = nuttin2c_core_v1.HTML.custom("div");
    ...
    dragOver(event) {
        ...
        const uploadBox = this.component.get("uploadBox");
        nuttin2c_core_v1.StyleSelectorAccessor.from(uploadBox).enable("file-upload-box-dragover");
    }
    ...
    dragLeave(event) {
        ...
        const uploadBox = this.component.get("uploadBox");
        nuttin2c_core_v1.StyleSelectorAccessor.from(uploadBox).disable("file-upload-box-dragover");
    }
...
class NumberInput extends CommonInput {
    ...
    constructor(name, model = null, placeholder = NumberInput.DEFAULT_PLACEHOLDER, mandatory = false) {
        ...
        super(NumberInput,
            name,
            model,
            new nuttin2c_core_v1.NumberValidator(mandatory, !mandatory),
            placeholder,
            "numberInput",
            "numberError");
    }
...
class PasswordInput extends CommonInput {
    ...
    constructor(name, model = null, placeholder = TextInput.DEFAULT_PLACEHOLDER, mandatory = false) {
        ...
        super(PasswordInput,
            name,
            model,
            new nuttin2c_core_v1.RequiredValidator(!mandatory),
            placeholder,
            "passwordInput",
            "passwordError");
    }
...
class PasswordMatcherInputValue extends CommonInput {
    ...
    constructor(name, model = null, placeholder = TextInput.DEFAULT_PLACEHOLDER, mandatory = false) {
        ...
        super(PasswordMatcherInputValue,
            name,
            model,
            new nuttin2c_core_v1.PasswordValidator(mandatory),
            placeholder,
...
class PasswordMatcherInputControl extends CommonInput {
    ...
    constructor(name, model = null, modelComparedPropertyName = null, placeholder = TextInput.DEFAULT_PLACEHOLDER,
        ...
        super(PasswordMatcherInputControl,
            name,
            model,
            new nuttin2c_core_v1.EqualsPropertyValidator(mandatory, false, model, modelComparedPropertyName),
            placeholder,
...
class PasswordMatcherInput {
    ...
    async postConfig() {
        ...
        nuttin2c_core_v1.CanvasStyles.enableStyle(PasswordMatcherInput.name);
        ...
        /** @type {AndValidatorSet} */
        this.validator = new nuttin2c_core_v1.AndValidatorSet()
...
class PhoneInput extends CommonInput {
    ...
    constructor(name, model = null, placeholder = TextInput.DEFAULT_PLACEHOLDER, mandatory = false) {
        ...
        super(PhoneInput,
            name,
            model,
            new nuttin2c_core_v1.PhoneValidator(mandatory, !mandatory),
            placeholder,
            "phoneInput",
            "phoneError");
    }
...
class RadioButton {
    ...
    postConfig() {
        ...
        nuttin2c_core_v1.CanvasStyles.enableStyle(RadioButton.name);
        this.component.get("radio").setAttributeValue("name",this.name);

        if (this.model) {
            nuttin2c_core_v1.InputElementDataBinding.link(this.model).to(this.component.get("radio"));
        }
...
class RadioToggleSwitch {
    ...
    postConfig() {
        ...
        nuttin2c_core_v1.CanvasStyles.enableStyle(RadioToggleSwitch.name);
...
class Select {
    ...
    postConfig() {
        ...
        nuttin2c_core_v1.CanvasStyles.enableStyle(Select.name);
        ...
        if (this.model) {
            nuttin2c_core_v1.InputElementDataBinding.link(this.model).to(this.component.get("select"));
        }
...
class TextInput$1 extends CommonInput {
    ...
    constructor(name, model = null, placeholder = TextInput$1.DEFAULT_PLACEHOLDER, mandatory = false) {
        ...
        super(TextInput$1,
            name,
            model,
            new nuttin2c_core_v1.RequiredValidator(false, mandatory),
            placeholder,
            "textInput",
            "textError");
    }
...
//# sourceMappingURL=data:application/json;charset=utf-8;base64,
