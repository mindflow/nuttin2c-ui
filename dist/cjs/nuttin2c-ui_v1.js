...
class SelectOptionsSource {
    ...
    constructor(keyValueOptions = new Map()) {
        ...
        keyValueOptions.forEach((value, key) => {
            optionsArray.push(new nuttin2cCore_v1.OptionElement(key, value));
        });
...
exports.SelectOptionsSource = SelectOptionsSource;
