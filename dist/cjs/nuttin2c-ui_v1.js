...
class CommonInput {
    ...
    postConfig() {
        ...
        if (this.placeholder && this.component.get("label")) {
            nuttin2cCore_v1.StyleSelectorAccessor.from(this.component.get("label")).disable("hidden");
